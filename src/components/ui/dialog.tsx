...
export function Dialog({open,onOpenChange:_onOpenChange,children}:{open:boolean;onOpenChange:(v:boolean)=>void;children:React.ReactNode}){return <>{open?children:null}</>}
