...
export interface Database {
  public: {
    ...
    Views: {
      v_line_status: { Row: { employee_id:string; user_id:string; full_name:string; email:string; project:string; default_schedule:string; active:boolean; blocked:boolean; shift_id:string|null; started_at:string|null; started_label:string|null; line_state:LineState; today_minutes:number; planned_start:string|null; planned_end:string|null; extra_hours:number|null } };
      v_daily_summary: { Row: { employee_id:string; work_date:string; full_name:string; project:string; first_start:string|null; last_end:string|null; worked_hours:number; extra_hours:number; shifts_count:number } };
      v_schedule_feed: { Row: { id:string; work_date:string; employee_id:string; full_name:string; project:string; planned_start:string; planned_end:string; extra_hours:number; reason:ExtraReason|null; comment:string; status:ApprovalStatus; created_at:string } };
    };
    Functions: {
